# Similar to unstructured_2d_dgsem/elixir_shallowwater_ec.jl
...
equations = ShallowWaterEquations2D(gravity = 9.81f0, threshold_partially_wet = 1.0f-4,
                                    threshold_desingularization = 1.0f-6)
