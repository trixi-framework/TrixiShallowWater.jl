...
# conditions
function Trixi.varnames(::typeof(cons2prim), ::ShallowWaterTwoLayerEquations2D)
...
@inline function Trixi.entropy(cons, equations::ShallowWaterTwoLayerEquations2D)
...
@inline function Trixi.energy_internal(cons, equations::ShallowWaterTwoLayerEquations2D)
