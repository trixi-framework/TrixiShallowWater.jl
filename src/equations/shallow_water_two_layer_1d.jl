...
# conditions
function Trixi.varnames(::typeof(cons2prim), ::ShallowWaterTwoLayerEquations1D)
    ("H_upper", "v_upper",
     "H_lower", "v_lower", "b")
end
...
@inline function Trixi.max_abs_speeds(u, equations::ShallowWaterTwoLayerEquations1D)
    h_upper, h_v_upper, h_lower, h_v_lower, _ = u
...
@inline function Trixi.velocity(u, equations::ShallowWaterTwoLayerEquations1D)
    h_upper, h_v_upper, h_lower, h_v_lower, _ = u
...
@inline function Trixi.cons2prim(u, equations::ShallowWaterTwoLayerEquations1D)
...
@inline function Trixi.cons2entropy(u, equations::ShallowWaterTwoLayerEquations1D)
    h_upper, _, h_lower, _, b = u
    v_upper, v_lower = velocity(u, equations)
...
@inline function Trixi.prim2cons(prim, equations::ShallowWaterTwoLayerEquations1D)
...
@inline function Trixi.waterheight(u, equations::ShallowWaterTwoLayerEquations1D)
    return SVector(u[1], u[3])
end

# Entropy function for the shallow water equations is the total energy
@inline function Trixi.entropy(cons, equations::ShallowWaterTwoLayerEquations1D)
    energy_total(cons, equations)
end

# Calculate total energy for a conservative state `cons`
@inline function Trixi.energy_total(cons, equations::ShallowWaterTwoLayerEquations1D)
...
@inline function Trixi.energy_kinetic(u, equations::ShallowWaterTwoLayerEquations1D)
    h_upper, h_v_upper, h_lower, h_v_lower, _ = u
...
@inline function Trixi.energy_internal(cons, equations::ShallowWaterTwoLayerEquations1D)
    return energy_total(cons, equations) - energy_kinetic(cons, equations)
end

# Calculate the error for the "lake-at-rest" test case where H = h_upper+h_lower+b should
# be a constant value over time
@inline function Trixi.lake_at_rest_error(u, equations::ShallowWaterTwoLayerEquations1D)
    h_upper, _, h_lower, _, b = u
